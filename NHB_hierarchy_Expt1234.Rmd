---
title: "Experiments 1-4 analysis code"
...
\newpage
# Abstract
Analysis code for Experiments 1-4 of "Structured action preparation during visuomotor decision-making." This script loads in data from usable participants in each experiment, concatenates all data frames, and runs main analyses.
Experiment 1 = sonaHL, Experiment 2 = fingerHL, Experiment 3 = oneDFL, Experiment 4 = threeDFL. In this code, "path distance" metrics are referred to in the column "treeDistance." This script uses only included data (i.e., no bad subjects) that was compiled previously. 
...
```
# Experiment 1: corrected rt x path distance
...
ggplot(sonaHL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.ticks.length = unit(tickLength,"cm"))
```
# Experiment 1: accuracy x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=3, fig.height=3, fig.align='center' }
...
\newpage 
# Experiment 1 models streak trials
...
AIC(sonaHL_MEM_tree_streak,sonaHL_MEM_flat_streak,sonaHL_MEM_feature_streak,sonaHL_MEM_finger_streak)
BIC(sonaHL_MEM_tree_streak,sonaHL_MEM_flat_streak,sonaHL_MEM_feature_streak,sonaHL_MEM_finger_streak)
```
...
```
# Experiment 2 corrected RT x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=3, fig.height=3, fig.align='center' }
...
# Experiment 2: accu x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=3, fig.height=3, fig.align='center' }
...
\newpage 
# Experiment 2 models streak trials
```{r, echo=F, message=F, warning=F, error=T, fig.width=3.5, fig.height=3, fig.align='center'}
#tree
...
AIC(fingerHL_MEM_tree_streak,fingerHL_MEM_flat_streak,fingerHL_MEM_feature_streak,fingerHL_MEM_finger_streak)
BIC(fingerHL_MEM_tree_streak,fingerHL_MEM_flat_streak,fingerHL_MEM_feature_streak,fingerHL_MEM_finger_streak)

anova(fingerHL_MEM_finger_streak,fingerHL_MEM_flat_streak,fingerHL_MEM_feature_streak,fingerHL_MEM_tree_streak)
```
\newpage
...
```
# Experiment 3: corrected RT x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=3, fig.height=3, fig.align='center' }
...
ggplot(oneDFL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.ticks.length = unit(tickLength,"cm"))
```
# Experiment 3 accuracy x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=3, fig.height=3, fig.align='center' }
...
\newpage 
# Experiment 3 models streak trials
```{r, echo=F, message=F, warning=F, error=T, fig.width=3.5, fig.height=3, fig.align='center'}
...
AIC(oneDFL_MEM_tree_streak,oneDFL_MEM_flat_streak,oneDFL_MEM_finger_streak)
BIC(oneDFL_MEM_tree_streak,oneDFL_MEM_flat_streak,oneDFL_MEM_finger_streak)
...
# add feature information to dataframe for feature analyses if needed
colors= read_csv("~/Documents/GitHub/StructuredActionPrepVMDM/compiledData/Experiment4_scrambled_colors.csv")
shapes= read_csv("~/Documents/GitHub/StructuredActionPrepVMDM/compiledData/Experiment4_scrambled_shapes.csv")
patterns= read_csv("~/Documents/GitHub/StructuredActionPrepVMDM/compiledData/Experiment4_scrambled_patterns.csv")
threeDFL$stim_color_val =NA
threeDFL$stim_shape_val =NA
threeDFL$stim_pattern_val =NA

threeDFL$resp_color_val =NA
threeDFL$resp_shape_val =NA
threeDFL$resp_pattern_val =NA

for(si in 1:length(subjNums_threeDFL)){
  subj = subjNums_threeDFL[si]
  stim_color = colors[[subj]]
  stim_shape = shapes[[subj]]
  stim_pattern = patterns[[subj]]

  for(sti in unique(threeDFL$stimNum)){
    threeDFL$stim_color_val[threeDFL$subject == subj & threeDFL$stimNum == sti] = stim_color[sti]
    threeDFL$stim_shape_val[threeDFL$subject == subj & threeDFL$stimNum == sti] = stim_shape[sti]
    threeDFL$stim_pattern_val[threeDFL$subject == subj & threeDFL$stimNum == sti] = stim_pattern[sti]
    
    threeDFL$resp_color_val[threeDFL$subject == subj & threeDFL$finger_press == sti] = stim_color[sti]
    threeDFL$resp_shape_val[threeDFL$subject == subj & threeDFL$finger_press == sti] = stim_shape[sti]
    threeDFL$resp_pattern_val[threeDFL$subject == subj & threeDFL$finger_press == sti] = stim_pattern[sti]

  }
}

threeDFL$colorMatch = NA
threeDFL$shapeMatch = NA
threeDFL$patternMatch = NA
threeDFL$colorMatch = (threeDFL$stim_color_val == threeDFL$resp_color_val)
threeDFL$shapeMatch = (threeDFL$stim_shape_val == threeDFL$resp_shape_val)
threeDFL$patternMatch = (threeDFL$stim_pattern_val == threeDFL$resp_pattern_val)

threeDFL$nFeatureMatch = NA
threeDFL$nFeatureMatch = threeDFL$colorMatch + threeDFL$shapeMatch + threeDFL$patternMatch
...
```
# Experiment 4: corrected RT x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=4, fig.height=4, fig.align='center' }
...
ggplot(threeDFL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.ticks.length = unit(tickLength,"cm"))
```
# Experiment 4: accuracy x path distance
```{r, echo=F, message=F, warning=F, error=T, fig.width=3, fig.height=3, fig.align='center' }
...
\newpage 
# Experiment 4 models streak trials
```{r, echo=F, message=F, warning=F, error=T, fig.width=3.5, fig.height=3, fig.align='center'}
#tree
...
AIC(threeDFL_MEM_tree_streak,threeDFL_MEM_flat_streak,threeDFL_MEM_feature_streak,threeDFL_MEM_finger_streak)
BIC(threeDFL_MEM_tree_streak,threeDFL_MEM_flat_streak,threeDFL_MEM_feature_streak,threeDFL_MEM_finger_streak)
...
sonaHL_BIC = BIC(sonaHL_MEM_tree_streak,sonaHL_MEM_flat_streak,sonaHL_MEM_feature_streak,sonaHL_MEM_finger_streak)
sonaHL_BIC$delta = sonaHL_BIC$BIC-sonaHL_BIC$BIC[1]
sonaHL_BIC$model = c('tree','flat','feature','finger')
sonaHL_BIC_delta = sonaHL_BIC %>% filter(model != 'tree')

fingerHL_BIC = BIC(fingerHL_MEM_tree_streak,fingerHL_MEM_flat_streak,fingerHL_MEM_feature_streak,fingerHL_MEM_finger_streak)
fingerHL_BIC$delta = fingerHL_BIC$BIC-fingerHL_BIC$BIC[1]
fingerHL_BIC$model = c('tree','flat','feature','finger')
fingerHL_BIC_delta = fingerHL_BIC %>% filter(model != 'tree')

oneDFL_BIC = BIC(oneDFL_MEM_tree_streak,oneDFL_MEM_flat_streak,oneDFL_MEM_finger_streak)
oneDFL_BIC$delta = oneDFL_BIC$BIC-oneDFL_BIC$BIC[1]
oneDFL_BIC$model = c('tree','flat','finger')
oneDFL_BIC_delta = oneDFL_BIC %>% filter(model != 'tree')

threeDFL_BIC = BIC(threeDFL_MEM_tree_streak,threeDFL_MEM_flat_streak,threeDFL_MEM_feature_streak,threeDFL_MEM_finger_streak)
threeDFL_BIC$delta = threeDFL_BIC$BIC-threeDFL_BIC$BIC[1]
threeDFL_BIC$model = c('tree','flat','feature','finger')
