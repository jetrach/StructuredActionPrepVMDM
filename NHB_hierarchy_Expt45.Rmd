...
ggplot(errorLevel_expt_summary_nocorr, aes(x =errorLevel,y = prop_corrected, group = errorLevel,fill = errorLevel)) + geom_bar(stat = 'identity')+ geom_errorbar(aes(x = errorLevel,ymin = prop_corrected-se, ymax = prop_corrected+se), width = .2)+facet_wrap(~expt)+scale_y_continuous(expand = c(0,0), limits = c(0,.13))+
  theme(axis.line=element_line(),
        panel.grid = element_blank(),
        panel.background = element_rect(fill = "white", colour = "black")
        ,panel.border = element_rect(fill = NA, colour = "white"),
        ...
        axis.ticks = element_line(colour = axisColor, size = tickWidth), 
        axis.ticks.length = unit(tickLength,"cm"))
#ggsave('Dyn_errorLevel_nocorr.eps')
...
anova_test(data.frame(errorLevel_expt_levels), dv = prop, wid = subject, between = expt, within = c(errorLevel), effect.size = 'pes')
...
anova_test(data.frame(HL_errorLevel_expt_levels), dv = prop, wid = subject,within = c(errorLevel), effect.size = 'pes')
anova_test(data.frame(FL_errorLevel_expt_levels), dv = prop, wid = subject, within = c(errorLevel), effect.size = 'pes')
...
anova_test(data.frame(errorLevel_expt_levels_errors), dv = prop, wid = subject, between = expt, within = c(errorLevel), effect.size = 'pes')
...
anova_test(data.frame(HL_errorLevel_expt_levels_errors), dv = prop, wid = subject,within = c(errorLevel), effect.size = 'pes')
anova_test(data.frame(FL_errorLevel_expt_levels_errors), dv = prop, wid = subject, within = c(errorLevel), effect.size = 'pes')
...
anova_test(data.frame(eml2errortype_noeml2), dv = prop, wid = subject, between = expt, within = c(errorType2), effect.size = 'pes')
...
anova_test(data.frame(accuDist_stim_eml), dv = accu, wid = subject, between = expt, within = c(treeDistance_stim, eml2), effect.size = 'pes')
