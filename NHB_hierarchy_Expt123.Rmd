...
structAccu_anova = anova_test(data.frame(sonaHL_accu_struct), dv = accu, wid = subject, between = hierarchy,effect.size = 'pes')


sonaHL_rt_struct = sonaHL %>% group_by(subject, hierarchy) %>% dplyr::summarise(avgRT = mean(rt, na.rm = TRUE))
structRT_anova =anova_test(data.frame(sonaHL_rt_struct), dv = avgRT, wid = subject, between = hierarchy,effect.size = 'pes')
...
ggplot(sonaHL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  geom_point(data=sonaHL_tree_streak, aes(x = as.factor(treeDistance), y = avgRT))+
...
ggplot(sonaHL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  geom_point(data = sonaHL_tree_streak, 
...
ggplot(fingerHL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  # Shift points slightly to the left and jitter them
  geom_point(data = fingerHL_tree_streak, 
             aes(x = as.numeric(as.factor(treeDistance)) + 0.1, y = avgRT), 
             position = position_jitter(width = 0.1), alpha = 1) +
...
ggsave('treeDistance_fingerHL_wpoints.eps')
```
...
ggplot(oneDFL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  # Shift points slightly to the left and jitter them
  geom_point(data = oneDFL_tree_streak, 
             aes(x = as.numeric(as.factor(treeDistance)) + 0.1, y = avgRT), 
             position = position_jitter(width = 0.1), alpha = 1) +
...
ggsave('treeDistance_oneDFL_wpoints.eps')
```
...
ggplot(threeDFL_tree_streak_summaryStats, aes(x = as.factor(treeDistance), y = avgRT)) + 
  ...
  # Shift points slightly to the left and jitter them
  geom_point(data = threeDFL_tree_streak, 
             aes(x = as.numeric(as.factor(treeDistance)) + 0.1, y = avgRT), 
             position = position_jitter(width = 0.1), alpha = 1) +
...
ggsave('treeDistance_threeDFL_wpoints.eps')
```
