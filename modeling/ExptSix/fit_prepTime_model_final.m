...
% sigmaall = hierarchical model (3 mu, 3 sigma),
% flat = flat model

clear all;close all;clc

DT = readtable('Experiment6_forced.csv');
...
flatDyn_flatnostructure_pt_model = fit; % name model
save flatDyn_flatnostructure_pt_model flatDyn_flatnostructure_pt_model; % save
...
flatDyn_hier_pt_model = fit; % name model
save flatDyn_hier_pt_model flatDyn_hier_pt_model; % save
...
flatDyn_hier_pt_model_sigmaall = fit; % name model
save flatDyn_hier_pt_model_sigmaall flatDyn_hier_pt_model_sigmaall; % save
else
